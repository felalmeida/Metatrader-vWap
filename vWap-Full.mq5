...
double          VWAP_Buffer_01[], VWAP_Buffer_02[], VWAP_Buffer_03[], VWAP_Buffer_04[], VWAP_Buffer_05[];
string          sLevel01Str = "", sLevel02Str = "", sLevel03Str = "", sLevel04Str = "", sLevel05Str = "";
...
int OnInit() {
    ...
    if (Enable_Level_01) {
        ...
        ObjectSetInteger(0, "VWAP_Level_01", OBJPROP_YDISTANCE, nStringYDistance);
    ...
    if (Enable_Level_02) {
        ...
        ObjectSetInteger(0, "VWAP_Level_02", OBJPROP_YDISTANCE, nStringYDistance);
    ...
    if (Enable_Level_03) {
        ...
        ObjectSetInteger(0, "VWAP_Level_03", OBJPROP_YDISTANCE, nStringYDistance);
    ...
    if (Enable_Level_04) {
        ...
        ObjectSetInteger(0, "VWAP_Level_04", OBJPROP_YDISTANCE, nStringYDistance);
    ...
    if (Enable_Level_05) {
        ...
        ObjectSetInteger(0, "VWAP_Level_05", OBJPROP_YDISTANCE, nStringYDistance);
...
void OnDeinit(const int pReason) {
    ...
    if (Enable_Level_01)    ObjectDelete(0, "VWAP_Level_01");
    if (Enable_Level_02)    ObjectDelete(0, "VWAP_Level_02");
    if (Enable_Level_03)    ObjectDelete(0, "VWAP_Level_03");
    if (Enable_Level_04)    ObjectDelete(0, "VWAP_Level_04");
    if (Enable_Level_05)    ObjectDelete(0, "VWAP_Level_05");
}
